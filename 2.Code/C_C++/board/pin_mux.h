...
#define BOARD_INITCSIPINS_IOMUXC_GPR_GPR26_GPIO_MUX1_GPIO_SEL_MASK 0x4000U /*!< GPIO1 and GPIO6 share same IO MUX function, GPIO_MUX1 selects one GPIO function: affected bits mask */
#define BOARD_INITCSIPINS_IOMUXC_GPR_GPR28_GPIO_MUX3_GPIO_SEL_MASK 0x08U /*!< GPIO3 and GPIO8 share same IO MUX function, GPIO_MUX3 selects one GPIO function: affected bits mask */
...
/* Routed pin properties */
#define BOARD_INITCSIPINS_CAN2_TX_PERIPHERAL                               GPIO6   /*!< Peripheral name */
#define BOARD_INITCSIPINS_CAN2_TX_SIGNAL                                 gpio_io   /*!< Signal name */
#define BOARD_INITCSIPINS_CAN2_TX_CHANNEL                                    14U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITCSIPINS_CAN2_TX_GPIO                                     GPIO6   /*!< GPIO peripheral base pointer */
#define BOARD_INITCSIPINS_CAN2_TX_GPIO_PIN                                   14U   /*!< GPIO pin number */
#define BOARD_INITCSIPINS_CAN2_TX_GPIO_PIN_MASK                      (1U << 14U)   /*!< GPIO pin mask */
#define BOARD_INITCSIPINS_CAN2_TX_PORT                                     GPIO6   /*!< PORT peripheral base pointer */
#define BOARD_INITCSIPINS_CAN2_TX_PIN                                        14U   /*!< PORT pin number */
#define BOARD_INITCSIPINS_CAN2_TX_PIN_MASK                           (1U << 14U)   /*!< PORT pin mask */

/* GPIO_SD_B1_03 (coord M4), FlexSPI_D0_B */
/* Routed pin properties */
#define BOARD_INITCSIPINS_FlexSPI_D0_B_PERIPHERAL                          GPIO8   /*!< Peripheral name */
#define BOARD_INITCSIPINS_FlexSPI_D0_B_SIGNAL                            gpio_io   /*!< Signal name */
#define BOARD_INITCSIPINS_FlexSPI_D0_B_CHANNEL                                3U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITCSIPINS_FlexSPI_D0_B_GPIO                                GPIO8   /*!< GPIO peripheral base pointer */
#define BOARD_INITCSIPINS_FlexSPI_D0_B_GPIO_PIN                               3U   /*!< GPIO pin number */
#define BOARD_INITCSIPINS_FlexSPI_D0_B_GPIO_PIN_MASK                  (1U << 3U)   /*!< GPIO pin mask */
#define BOARD_INITCSIPINS_FlexSPI_D0_B_PORT                                GPIO8   /*!< PORT peripheral base pointer */
#define BOARD_INITCSIPINS_FlexSPI_D0_B_PIN                                    3U   /*!< PORT pin number */
#define BOARD_INITCSIPINS_FlexSPI_D0_B_PIN_MASK                       (1U << 3U)   /*!< PORT pin mask */
...
/* Routed pin properties */
#define BOARD_INITLCDPINS_ENET_RXD0_PERIPHERAL                             LCDIF   /*!< Peripheral name */
#define BOARD_INITLCDPINS_ENET_RXD0_SIGNAL                            lcdif_data   /*!< Signal name */
#define BOARD_INITLCDPINS_ENET_RXD0_CHANNEL                                  16U   /*!< Signal channel */

/* GPIO_B1_05 (coord D12), ENET_RXD1 */
/* Routed pin properties */
#define BOARD_INITLCDPINS_ENET_RXD1_PERIPHERAL                             LCDIF   /*!< Peripheral name */
#define BOARD_INITLCDPINS_ENET_RXD1_SIGNAL                            lcdif_data   /*!< Signal name */
#define BOARD_INITLCDPINS_ENET_RXD1_CHANNEL                                  17U   /*!< Signal channel */

/* GPIO_B1_06 (coord C12), ENET_CRS_DV */
/* Routed pin properties */
#define BOARD_INITLCDPINS_ENET_CRS_DV_PERIPHERAL                           LCDIF   /*!< Peripheral name */
#define BOARD_INITLCDPINS_ENET_CRS_DV_SIGNAL                          lcdif_data   /*!< Signal name */
#define BOARD_INITLCDPINS_ENET_CRS_DV_CHANNEL                                18U   /*!< Signal channel */

/* GPIO_B1_07 (coord B12), ENET_TXD0 */
/* Routed pin properties */
#define BOARD_INITLCDPINS_ENET_TXD0_PERIPHERAL                             LCDIF   /*!< Peripheral name */
#define BOARD_INITLCDPINS_ENET_TXD0_SIGNAL                            lcdif_data   /*!< Signal name */
#define BOARD_INITLCDPINS_ENET_TXD0_CHANNEL                                  19U   /*!< Signal channel */

/* GPIO_B1_08 (coord A12), ENET_TXD1 */
/* Routed pin properties */
#define BOARD_INITLCDPINS_ENET_TXD1_PERIPHERAL                             LCDIF   /*!< Peripheral name */
#define BOARD_INITLCDPINS_ENET_TXD1_SIGNAL                            lcdif_data   /*!< Signal name */
#define BOARD_INITLCDPINS_ENET_TXD1_CHANNEL                                  20U   /*!< Signal channel */

/* GPIO_B1_09 (coord A13), ENET_TXEN */
/* Routed pin properties */
#define BOARD_INITLCDPINS_ENET_TXEN_PERIPHERAL                             LCDIF   /*!< Peripheral name */
#define BOARD_INITLCDPINS_ENET_TXEN_SIGNAL                            lcdif_data   /*!< Signal name */
#define BOARD_INITLCDPINS_ENET_TXEN_CHANNEL                                  21U   /*!< Signal channel */

/* GPIO_B1_10 (coord B13), ENET_TX_CLK */
/* Routed pin properties */
#define BOARD_INITLCDPINS_ENET_TX_CLK_PERIPHERAL                           LCDIF   /*!< Peripheral name */
#define BOARD_INITLCDPINS_ENET_TX_CLK_SIGNAL                          lcdif_data   /*!< Signal name */
#define BOARD_INITLCDPINS_ENET_TX_CLK_CHANNEL                                22U   /*!< Signal channel */

/* GPIO_B1_11 (coord C13), ENET_RXER */
/* Routed pin properties */
#define BOARD_INITLCDPINS_ENET_RXER_PERIPHERAL                             LCDIF   /*!< Peripheral name */
#define BOARD_INITLCDPINS_ENET_RXER_SIGNAL                            lcdif_data   /*!< Signal name */
#define BOARD_INITLCDPINS_ENET_RXER_CHANNEL                                  23U   /*!< Signal channel */
